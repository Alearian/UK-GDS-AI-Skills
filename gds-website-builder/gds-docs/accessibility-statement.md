...
## Compliance status
The Design System website at [design-system.service.gov.uk](./index.md) is fully compliant with the Web Content Accessibility Guidelines (WCAG) version 2.2 AA standard.
...
The [GOV.UK Design System website](./index.md) was last audited for accessibility issues by an external group in July 2024. The test was carried out by the [Digital Accessibility Centre (DAC)](https://digitalaccessibilitycentre.org/).
