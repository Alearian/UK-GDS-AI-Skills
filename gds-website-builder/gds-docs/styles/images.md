#  Images 
  * [ Using images to give information ](./styles/images/#using-images-to-give-information.md)
  * [ Photography ](./styles/images/#photography.md)
  * [ Illustrations ](./styles/images/#illustrations.md)
  * [ Icons ](./styles/images/#icons.md)
  * [ Avoid images that contain text ](./styles/images/#avoid-images-that-contain-text.md)
  * [ Alt text ](./styles/images/#alt-text.md)
  * [ Research on images ](./styles/images/#research-on-images.md)
...
If you choose to add an image to your service, you’ll need to carefully decide if the image needs to be described with [alternative text (alt text)](./styles/images/#alt-text.md).
## Photography
...
Start by following the [guidance on colour, and use the GOV.UK colour palette](./styles/colour.md).
...
[ Open this example in a new tab: alt text – images ](./styles/images/alt-text.md)
  * [HTML](./styles/images/#alt-text-images-example-open-html.md)
...
In particular, we added a section on how to use images and ensure they’re as accessible as possible – giving advice to teams on how to meet or surpass relevant WCAG AA guidelines, in line with the [GOV.UK Design System accessibility strategy](./accessibility/accessibility-strategy.md).
...
To help make sure that this page is useful, relevant and up to date, you can: 
  * take part in the [ ‘Images’ discussion on GitHub ](https://github.com/alphagov/govuk-design-system-backlog/issues/70) and share your research 
  * [propose a change on GitHub](https://github.com/alphagov/govuk-design-system/edit/main/src/styles/images/index.md) – read more about [ how to propose changes in GitHub ](./community/propose-a-content-change-using-github.md)

## Need help?
If you’ve got a question about the GOV.UK Design System, [contact the team](./contact.md). 
[ ](./styles/images/#top.md)
