...
![A focused link against different GOV.UK background colours](./get-started/focus-states/link-focus.png.md)
Other components and elements that look like links use the link focus state style. For example, the controls on the [Accordion component](./components/accordion.md) and [Details component](./components/details.md).
![A focused details component. In the examples, the expandable text reads 'Help with nationality' and beneath is an explanation of why the user is being asked for this information.](./get-started/focus-states/details-focus.png.md)
...
![A text input labelled 'What is your name?'. The example shows the text input both unfocused and focused.](./get-started/focus-states/text-input-focus.png.md)
[Radios components](./components/radios.md) and [checkboxes components](./components/checkboxes.md) use the same style.
![Yes and no radio options to answer the question 'Have you changed your name?'. In this example, the 'No' option is focused.](./get-started/focus-states/radios-focus.png.md)
## Making focus states accessible for extended and modified components
If you’ve [extended or modified components in the GOV.UK Design System](./get-started/extending-and-modifying-components.md), you can use GOV.UK styles to make the focus states of these components accessible.
...
To make a component’s focus state accessible without using Sass, you can:
  ...
  * get the values for `govuk-functional-colour(focus)` and `govuk-functional-colour(focus-text)` from the [colour page](./styles/colour.md)
...
[ ](./get-started/focus-states/#top.md)
