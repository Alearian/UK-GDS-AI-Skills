...
[ Open this example in a new tab: back link ](./components/back-link/default.md)
  * [HTML](./components/back-link/#back-link-example-html.md)
  * [Nunjucks](./components/back-link/#back-link-example-nunjucks.md)
...
Always include the Back link component on GOV.UK [Question pages in your service](./patterns/question-pages.md).
You can include a back link on other pages within a multi-page transaction, if it makes sense to do so.
## When not to use this component
Never use the back link component together with the [Breadcrumbs component](./components/breadcrumbs.md). If necessary, you should do research with your users to learn which they find more helpful in your service.
## How it works
...
[ Open this example in a new tab: back link second ](./components/back-link/default.md)
  * [HTML](./components/back-link/#back-link-second-example-html.md)
  * [Nunjucks](./components/back-link/#back-link-second-example-nunjucks.md)
...
[ Open this example in a new tab: inverse back link – back link ](./components/back-link/inverse.md)
  * [HTML](./components/back-link/#inverse-back-link-back-link-example-html.md)
  * [Nunjucks](./components/back-link/#inverse-back-link-back-link-example-nunjucks.md)
...
To help make sure that this page is useful, relevant and up to date, you can: 
  * take part in the [ ‘Back link’ discussion on GitHub ](https://github.com/alphagov/govuk-design-system-backlog/issues/32) and share your research 
  * [propose a change on GitHub](https://github.com/alphagov/govuk-design-system/edit/main/src/components/back-link/index.md) – read more about [ how to propose changes in GitHub ](./community/propose-a-content-change-using-github.md)

## Need help?
If you’ve got a question about the GOV.UK Design System, [contact the team](./contact.md). 
[ ](./components/back-link/#top.md)
