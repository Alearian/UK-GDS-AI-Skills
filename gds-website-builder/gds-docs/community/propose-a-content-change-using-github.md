...
If you get stuck whilst following these steps and you need help, you can:
  ...
  * email the GOV.UK Design System team on   
...
![](./community/propose-a-content-change-using-github/fork-this-repo.png.md)
...
![The checkboxes description in the file in GitHub with an uppercase C in the word checkboxes](./community/propose-a-content-change-using-github/checkboxes-uppercase.png.md)
In this example, the uppercase ‘C’ on the word ‘Checkbox’ has been changed to lowercase.
![The checkboxes description in the file in GitHub after the C in the word checkboxes has been changed to lowercase](./community/propose-a-content-change-using-github/checkboxes-lowercase.png.md)
...
![Propose file change view in GitHub. There is a summary of the change and a longer description beneath it. There are 2 buttons, one with the option to propose the change and one to cancel it.](./community/propose-a-content-change-using-github/propose-file-change.png.md)
...
![Create pull request view in GitHub showing a before and after view of the file you have changed and a button labelled create pull request.](./community/propose-a-content-change-using-github/create-pull-request-first-view-github.png.md)
...
![Create pull request view in GitHub. It is pre-filled with the summary and the description from the previous propose change view. There is a button to create a pull request.](./community/propose-a-content-change-using-github/create-pull-request-view-github.png.md)
...
[ ](./community/propose-a-content-change-using-github/#top.md)
