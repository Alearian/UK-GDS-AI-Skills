...
If you have any questions or feedback, [contact the team](./contact.md).
## February 2026
...
It includes updates to the:
  * [GOV.UK header component](./components/header.md)
  * [GOV.UK footer component](./components/footer.md)
  * [Service navigation component](./components/service-navigation.md)
...
This release includes a [JavaScript enhancement to the File upload component](./components/file-upload/#using-the-improved-file-upload-component.md), which makes dragging and dropping files easier for users.
