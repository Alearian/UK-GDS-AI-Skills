...
The Design System team focuses on developing [prioritised components and patterns](./community/upcoming-components-patterns.md) with the community. However, anyone can choose to work on something from the [list of discussions on GitHub](https://github.com/orgs/alphagov/projects/43/views/2).
...
If you have an idea for a new component or pattern that’s not already on the list, [see how to propose a component or pattern](./community/propose-a-component-or-pattern.md).
...
Once you have researched the component or pattern and shown it works for users, the [Design System working group](./community/design-system-working-group.md) will review it.
## Send your contribution for review
All components and patterns must meet the [contribution criteria](./community/contribution-criteria.md) before they can be published. The Design System working group will use the criteria to review your contribution.
...
[ ](./community/develop-a-component-or-pattern/#top.md)
