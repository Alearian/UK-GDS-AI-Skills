...
Select the thing you want to share findings about. If what you’re looking for is not on the list, read about [how to propose a component or pattern](./community/propose-a-component-or-pattern.md).
...
If you do not want to use GitHub or would rather share your findings privately, you can [contact the team directly](./contact.md) either by email or by sending a direct message on Slack.
## Research template
...
We share the chosen priorities on the [Upcoming components and patterns page](./community/upcoming-components-patterns.md).
## Need help?
If you’ve got a question about the GOV.UK Design System, [contact the team](./contact.md). 
[ ](./community/share-research-findings/#top.md)
