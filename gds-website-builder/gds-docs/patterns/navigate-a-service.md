...
Use this pattern to plan and design your navigation header using the [GOV.UK header component](./components/header.md) and [Service navigation component](./components/service-navigation.md). Check the ‘When to use this component’ sections in each of these components to make sure they’re right for your service.
...
Use a [Task list component](./components/task-list.md) instead, as they’re better for helping users understand:
  * the tasks involved in completing a transaction
  * the order they should complete tasks in
  * when they’ve completed tasks

See how to do this in the [Help users to complete multiple tasks pattern](./patterns/complete-multiple-tasks.md).
## How it works
Together, the [GOV.UK header component](./components/header.md) and [Service navigation component](./components/service-navigation.md) work together to assure users that they’re in the right place to use your service. They also help users understand that GOV.UK functions as one website.
...
The [GOV.UK header component](./components/header.md) should only be used to show the GOV.UK logo and any GOV.UK-wide tools used in your service, such as GOV.UK One Login.
If you need to show your service name or add navigation links, use the [Service navigation component](./components/service-navigation.md).
...
Once users enter your service, they should have all the information they need to complete it [from your service’s Start page](./patterns/start-using-a-service.md). If you need to refer to specific information as part of your service’s journey, use links within your pages.
### Plan your Service navigation
Use the [Service navigation component](./components/service-navigation.md) to show your service name, navigation links and other service-level tools.
...
The [Service navigation component includes ‘slots’](./components/service-navigation/#use-slots-to-add-custom-elements.md) to support this. You’ll need to decide on the most appropriate layout and positioning and provide your own styles.
...
#### Phase banners
Show the [Phase banner component](./components/phase-banner.md) directly under either:
...
If your service uses the [Breadcrumbs component](./components/breadcrumbs.md), place them just before the `<main>` element. Placing them here means that the ‘Skip to main content’ link allows the user to skip all navigation links, including breadcrumbs.
## How the GOV.UK header and Service navigation work together
We introduced this pattern and the [Service navigation component](./components/service-navigation.md) in August 2024. You can no longer use the GOV.UK header to show service name or navigation links.
...
To help make sure that this page is useful, relevant and up to date, you can: 
  * take part in the [ ‘Navigate a service’ discussion on GitHub ](https://github.com/alphagov/govuk-design-system-backlog/issues/76) and share your research 
  * [propose a change on GitHub](https://github.com/alphagov/govuk-design-system/edit/main/src/patterns/navigate-a-service/index.md) – read more about [ how to propose changes in GitHub ](./community/propose-a-content-change-using-github.md)

## Need help?
If you’ve got a question about the GOV.UK Design System, [contact the team](./contact.md). 
[ ](./patterns/navigate-a-service/#top.md)
