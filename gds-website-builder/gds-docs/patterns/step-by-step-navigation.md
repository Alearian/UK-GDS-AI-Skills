...
![A screenshot showing an example of the step by step navigation pattern](./patterns/step-by-step-navigation/step-by-step-navigation.png.md)
...
Do not use the step by step pattern:
  ...
  * inside a transactional service – use the [Complete multiple tasks pattern](./patterns/complete-multiple-tasks.md) instead
...
![A screenshot showing an example of the step by step as a sidebar](./patterns/step-by-step-navigation/step-by-step-sidebar.png.md)
  2. As a standalone page.
![A screenshot showing an example of the step by step navigation pattern](./patterns/step-by-step-navigation/step-by-step-standalone-page.png.md)
...
![A screenshot showing an example of the link at the top of a page to the step by step page](./patterns/step-by-step-navigation/step-by-step-content-header.png.md)
...
![A screenshot showing an example of the step by step navigation summary](./patterns/step-by-step-navigation/step-by-step-summary.png.md)
#### Steps
...
![A screenshot showing an example of the step by step navigation task](./patterns/step-by-step-navigation/step-by-step-task.png.md)
...
![A screenshot showing an example of the step by step navigation pattern with an 'and' step](./patterns/step-by-step-navigation/step-by-step-and.png.md) ![A screenshot showing an example of the step by step navigation pattern with an 'or' step](./patterns/step-by-step-navigation/step-by-step-or.png.md)
### Costs
If there is a cost for completing a task, show it after the link text.
![A screenshot showing an example of showing the cost of a step](./patterns/step-by-step-navigation/step-by-step-cost.png.md)
### Text within a step
...
![A screenshot showing an example of a step with instructions](./patterns/step-by-step-navigation/step-by-step-instructions.png.md)
...
To help make sure that this page is useful, relevant and up to date, you can: 
  * take part in the [ ‘Step by step navigation’ discussion on GitHub ](https://github.com/alphagov/govuk-design-system-backlog/issues/171) and share your research 
  * [propose a change on GitHub](https://github.com/alphagov/govuk-design-system/edit/main/src/patterns/step-by-step-navigation/index.md) – read more about [ how to propose changes in GitHub ](./community/propose-a-content-change-using-github.md)

## Need help?
If you’ve got a question about the GOV.UK Design System, [contact the team](./contact.md). 
[ ](./patterns/step-by-step-navigation/#top.md)
