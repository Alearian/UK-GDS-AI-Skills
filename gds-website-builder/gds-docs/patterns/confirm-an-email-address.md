#  Help users to  Confirm an email address 
...
Most email confirmation loops will send the user a link and ask them to click it to return to the service. Another approach is to send the user a security code, similar to the [Confirm a phone number pattern](./patterns/confirm-a-phone-number.md), and ask the user to enter it.
...
To help make sure that this page is useful, relevant and up to date, you can: 
  * take part in the [ ‘Confirm an email address’ discussion on GitHub ](https://github.com/alphagov/govuk-design-system-backlog/issues/39) and share your research 
  * [propose a change on GitHub](https://github.com/alphagov/govuk-design-system/edit/main/src/patterns/confirm-an-email-address/index.md) – read more about [ how to propose changes in GitHub ](./community/propose-a-content-change-using-github.md)

## Need help?
If you’ve got a question about the GOV.UK Design System, [contact the team](./contact.md). 
[ ](./patterns/confirm-an-email-address/#top.md)
