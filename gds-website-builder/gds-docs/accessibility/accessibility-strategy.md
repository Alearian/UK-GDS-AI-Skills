#  Accessibility strategy 
  * [ Accessibility and design systems ](./accessibility/accessibility-strategy/#accessibility-and-design-systems.md)
  * [ Principles for increasing accessibility ](./accessibility/accessibility-strategy/#principles-for-increasing-accessibility.md)
  * [ Prioritising accessibility concerns ](./accessibility/accessibility-strategy/#prioritising-accessibility-concerns.md)
  * [ Baseline WCAG accessibility compliance ](./accessibility/accessibility-strategy/#baseline-wcag-accessibility-compliance.md)
  * [ Testing accessibility concerns ](./accessibility/accessibility-strategy/#testing-accessibility-concerns.md)
  * [ Recording accessibility concerns ](./accessibility/accessibility-strategy/#recording-accessibility-concerns.md)
  * [ Proposed accessibility activities ](./accessibility/accessibility-strategy/#proposed-accessibility-activities.md)
  * [ Performance measurement ](./accessibility/accessibility-strategy/#performance-measurement.md)
  * [ Terms used in this strategy ](./accessibility/accessibility-strategy/#terms-used-in-this-strategy.md)
  * [ WCAG-related dates ](./accessibility/accessibility-strategy/#wcag-related-dates.md)
...
Accessibility concerns can surface in any product, including:
  * [GOV.UK Frontend](./get-started/production.md)
  * the [GOV.UK Design System website](./index.md)
...
Feedback from users and other proof of real-world impact provides much stronger evidence for the team, especially when determining priority and urgency. When resolving an accessibility concern involves a solution that causes a [breaking change](./accessibility/accessibility-strategy/#breaking-releases-and-breaking-changes.md), strong evidence helps justify the change.
...
If the GOV.UK Design System team is unable to confirm the accessibility concern or disagrees with the raised concern, then the following steps are taken to resolve the disagreement:
  ...
  2. If the accessibility concern is [not determined to be high-severity](./accessibility/accessibility-strategy/#determining-severity-of-an-accessibility-concern.md), continue to hold discussions within the team and any frontend and accessibility communities where applicable
...
If an accessibility concern turns out to be a bug the team cannot quickly fix, the team will determine whether it should be recorded in the [GOV.UK Design System accessibility statement](./accessibility-statement.md).
...
If the GOV.UK Design System does not meet the requirements of level AA accessibility compliance, the team will update the [GOV.UK Design System accessibility statement](./accessibility-statement.md) and keep the records of changes required until compliance is met.
...
Initially, the team will assess the performance of this accessibility strategy by measuring the:
  ...
  * number of accessibility concerns listed in the [GOV.UK Design System accessibility statement](./accessibility-statement.md)
...
The team will gather performance measurement results every 6 months and record them in the team’s internal documentation. The team will also review the [GOV.UK Design System accessibility statement](./accessibility-statement.md) every 6 months and update as needed.
...
## WCAG-related dates
### September 2022
WCAG 2.2 published a new ‘Candidate recommendation’ version on 6 September 2022. At this stage, “W3C encourages developers to use the technical report in their projects”.
### 5 October 2023
WCAG 2.2 formally published by W3C. At this stage, it’s a final and official web standard. WCAG 2.2 is backwards compatible with WCAG 2.1, thanks partly to a September 2023 update which helps deprecate [Success Criterion 4.1.1: Parsing for HTML and XML](https://www.w3.org/WAI/WCAG22/Understanding/parsing.html).
### 8 December 2023
...
[ ](./accessibility/accessibility-strategy/#top.md)
