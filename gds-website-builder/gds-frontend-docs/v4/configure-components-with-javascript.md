#  [](./v4/configure-components-with-javascript/#configure-components-with-javascript.md)Configure components with JavaScript
You can configure some of the components in GOV.UK Frontend to customise their behaviour or to [localise their JavaScript to use a language other than English](./v4/localise-govuk-frontend.md).
...
##  [](./v4/configure-components-with-javascript/#setting-nunjucks-macro-options.md)Setting Nunjucks macro options
...
##  [](./v4/configure-components-with-javascript/#passing-configuration-using-data-attributes-in-html.md)Passing configuration using data attributes in HTML
...
Read the [JavaScript API Reference](./v4/javascript-api-reference.md) for the configuration accepted by each component. You’ll need to convert the configuration names into kebab-case.
##  [](./v4/configure-components-with-javascript/#passing-configuration-to-a-new-instance-of-a-component-in-javascript.md)Passing configuration to a new instance of a component in JavaScript
...
Some configuration options might accept object values or be grouped under a namespace to keep related things together. For example, [the localisation options](./v4/localise-govuk-frontend.md) are grouped under the `i18n` namespace. When using these options, use nested objects. For example:
...
Read the [JavaScript API Reference](./v4/javascript-api-reference.md) to see what configuration each component accepts.
##  [](./v4/configure-components-with-javascript/#passing-configuration-using-the-initall-function.md)Passing configuration using the initAll function
...
```
  ...
  * [View source](https://github.com/alphagov/govuk-frontend-docs/blob/master/source/v4/configure-components-with-javascript/index.html.md.erb)
  * [Report problem](https://github.com/alphagov/govuk-frontend-docs/issues/new?body=Problem+with+%27Configure+components+with+JavaScript+%28v4.x%29%27+%28https%3A%2F%2Ffrontend.design-system.service.gov.uk%2Fv4%2Fconfigure-components-with-javascript%2F%29&labels=bug&title=Re%3A+%27Configure+components+with+JavaScript+%28v4.x%29%27)
