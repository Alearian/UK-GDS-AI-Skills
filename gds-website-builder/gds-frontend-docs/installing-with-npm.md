#  [](./installing-with-npm/#install-with-node-js-package-manager-npm.md)Install with Node.js package manager (npm)
##  [](./installing-with-npm/#requirements.md)Requirements
...
You might see deprecation warnings when compiling your Sass. If required, you can [silence deprecation warnings caused by dependencies](./import-css/#silence-deprecation-warnings-from-dependencies-in-dart-sass.md).
...
You can also [install Nunjucks v3.0.0 or later](https://www.npmjs.com/package/nunjucks) if you want to [use GOV.UK Frontend’s Nunjucks macros](./use-nunjucks.md).
##  [](./installing-with-npm/#install-gov-uk-frontend.md)Install GOV.UK Frontend
Run:
...
##  [](./installing-with-npm/#get-the-css-assets-and-javascript-working.md)Get the CSS, Assets and JavaScript working
...
###  [](./installing-with-npm/#get-the-css-working.md)Get the CSS working
...
There are also different ways you can [import GOV.UK Frontend’s CSS](./import-css.md), including into your project’s main Sass file:
...
###  [](./installing-with-npm/#get-the-font-and-images-working.md)Get the font and images working
...
In your live application, we recommend [using an automated task or your build pipeline](./import-font-and-images-assets.md) instead of copying the files manually.
###  [](./installing-with-npm/#get-the-javascript-working.md)Get the JavaScript working
...
In your live application, we recommend:
  * [using an automated task or your build pipeline](./import-javascript.md) instead of copying the files manually
  * importing only the components your application uses and [using `createAll` to initialise](./import-javascript/#import-individual-components.md) all their instances on the page
...
Once your testing is complete you can use the full code for page layouts and other components from the [Design System website](https://design-system.service.gov.uk/).
  * [View source](https://github.com/alphagov/govuk-frontend-docs/blob/master/source/installing-with-npm/index.html.md.erb)
  * [Report problem](https://github.com/alphagov/govuk-frontend-docs/issues/new?body=Problem+with+%27Install+with+Node.js+package+manager+%28npm%29%27+%28https%3A%2F%2Ffrontend.design-system.service.gov.uk%2Finstalling-with-npm%2F%29&labels=bug&title=Re%3A+%27Install+with+Node.js+package+manager+%28npm%29%27)
