#  [](./v5/localise-govuk-frontend/#localise-gov-uk-frontend.md)Localise GOV.UK Frontend
...
##  [](./v5/localise-govuk-frontend/#changing-the-text-you-pass-to-a-component.md)Changing the text you pass to a component
You’re in control of this text and are responsible for localising it.
##  [](./v5/localise-govuk-frontend/#changing-the-text-in-the-html-for-a-component.md)Changing the text in the HTML for a component
...
##  [](./v5/localise-govuk-frontend/#changing-text-in-the-javascript-for-a-component.md)Changing text in the JavaScript for a component
...
Alternatively, you can [configure the component with JavaScript](./v5/configure-components.md) at the point you initialise it or when using `initAll`.
...
###  [](./v5/localise-govuk-frontend/#setting-the-locale-for-a-component.md)Setting the locale for a component
...
###  [](./v5/localise-govuk-frontend/#understanding-pluralisation-rules.md)Understanding pluralisation rules
...
The following example shows how to provide pluralisation options using the different ways you can [configure components with JavaScript](./v5/configure-components.md):
With Nunjucks
...
```
  ...
  * [View source](https://github.com/alphagov/govuk-frontend-docs/blob/master/source/v5/localise-govuk-frontend/index.html.md.erb)
  * [Report problem](https://github.com/alphagov/govuk-frontend-docs/issues/new?body=Problem+with+%27Localise+GOV.UK+Frontend%27+%28https%3A%2F%2Ffrontend.design-system.service.gov.uk%2Fv5%2Flocalise-govuk-frontend%2F%29&labels=bug&title=Re%3A+%27Localise+GOV.UK+Frontend%27)
