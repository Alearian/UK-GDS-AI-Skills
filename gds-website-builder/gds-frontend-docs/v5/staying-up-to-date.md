#  [](./v5/staying-up-to-date/#staying-up-to-date-with-changes.md)Staying up to date with changes
...
##  [](./v5/staying-up-to-date/#getting-updates-when-we-publish-a-new-release.md)Getting updates when we publish a new release
...
##  [](./v5/staying-up-to-date/#find-out-which-version-you-39-re-currently-using.md)Find out which version you’re currently using
...
##  [](./v5/staying-up-to-date/#understanding-what-has-changed.md)Understanding what has changed
How to interpret the version numbering and the release notes.
###  [](./v5/staying-up-to-date/#how-the-version-numbering-works.md)How the version numbering works
...
We aim to follow [semantic versioning](https://semver.org/). This means we will:
  ...
  * increase the `MAJOR` number and reset the `MINOR` and `PATCH` numbers to 0 if a release might require you to make changes to your service when you update (see [breaking changes](./v5/staying-up-to-date/#breaking-changes.md)), for example going from v4.7.0 to v5.0.0
...
###  [](./v5/staying-up-to-date/#using-the-release-notes.md)Using the release notes
...
####  [](./v5/staying-up-to-date/#breaking-changes.md)Breaking changes
...
####  [](./v5/staying-up-to-date/#recommended-changes.md)Recommended changes
...
####  [](./v5/staying-up-to-date/#new-features.md)New features
...
####  [](./v5/staying-up-to-date/#deprecations.md)Deprecations
...
####  [](./v5/staying-up-to-date/#fixes.md)Fixes
...
##  [](./v5/staying-up-to-date/#updating-to-the-latest-version.md)Updating to the latest version
...
###  [](./v5/staying-up-to-date/#updating-to-the-latest-version-if-you-installed-gov-uk-frontend-using-npm.md)Updating to the latest version if you installed GOV.UK Frontend using npm
...
###  [](./v5/staying-up-to-date/#updating-to-the-latest-version-if-you-installed-gov-uk-frontend-using-precompiled-files.md)Updating to the latest version if you installed GOV.UK Frontend using precompiled files
...
You should also remove older versions of the precompiled CSS and JavaScript, and any other files that no longer exist in the latest release.
  * [View source](https://github.com/alphagov/govuk-frontend-docs/blob/master/source/v5/staying-up-to-date/index.html.md.erb)
  * [Report problem](https://github.com/alphagov/govuk-frontend-docs/issues/new?body=Problem+with+%27Staying+up+to+date+with+changes%27+%28https%3A%2F%2Ffrontend.design-system.service.gov.uk%2Fv5%2Fstaying-up-to-date%2F%29&labels=bug&title=Re%3A+%27Staying+up+to+date+with+changes%27)
