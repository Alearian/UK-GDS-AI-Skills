#  [](./v5/install-using-precompiled-files/#try-gov-uk-frontend-using-precompiled-files.md)Try GOV.UK Frontend using precompiled files
...
##  [](./v5/install-using-precompiled-files/#what-you-cannot-do-with-the-precompiled-files.md)What you cannot do with the precompiled files
You’ll not be able to:
  * change [Sass settings](./v5/sass-api-reference.md), for example override colours or set your own font
...
##  [](./v5/install-using-precompiled-files/#copy-and-install-the-precompiled-files.md)Copy and install the precompiled files
...
##  [](./v5/install-using-precompiled-files/#create-an-example-page-to-check-for-errors.md)Create an example page to check for errors
...
```
  ...
  2. Replace `<VERSION-NUMBER>` so the 3 filenames match the files you [copied from GOV.UK Frontend’s GitHub repo](./v5/install-using-precompiled-files/#copy-and-install-the-precompiled-files.md).
...
If the accordion does not work, you can find out more about how to import GOV.UK Frontend’s CSS and JavaScript in:
  * [Import CSS](./v5/import-css.md)
  * [Import JavaScript](./v5/import-javascript.md)

  * [View source](https://github.com/alphagov/govuk-frontend-docs/blob/master/source/v5/install-using-precompiled-files/index.html.md.erb)
  * [Report problem](https://github.com/alphagov/govuk-frontend-docs/issues/new?body=Problem+with+%27Install+using+precompiled+files%27+%28https%3A%2F%2Ffrontend.design-system.service.gov.uk%2Fv5%2Finstall-using-precompiled-files%2F%29&labels=bug&title=Re%3A+%27Install+using+precompiled+files%27)
